...
class ModelConfigWidget:
    ...
    def _build_ui(self):
        ...
        self.run_mode_combo.addItem("云端 API 模式", "cloud")
        self.run_mode_combo.addItem("本地模型模式", "local")
        ...
        llm_label = QLabel("大模型:")
        llm_label.setFixedWidth(label_width)
        ...
        base_label.setFixedWidth(label_width)
        ...
        self.show_api_checkbox = QCheckBox("显示")
        ...
        local_model_label = QLabel("本地模型路径:")
        local_model_label.setFixedWidth(label_width)
        ...
        self.local_model_path_edit.setPlaceholderText("请选择 .gguf 模型文件")
        self.browse_local_model_button = QPushButton("浏览...")
        self.browse_local_model_button.setFixedWidth(100)
        ...
        concurrent_label.setFixedWidth(label_width)
    ...
    def _update_llm_options(self, mode):
        ...
        if mode == "cloud":
            ...
            self.llm_combo.addItem("智谱 GLM-4", "glm-4")
            self.llm_combo.addItem("自定义模型", "custom")
